...
worker는 같은 `DevAutomationDbContext`를 사용하고, Serilog는 콘솔과 파일에
구조화 로그를 남깁니다.
...
- Migration: `src/DevAutomation.Infrastructure/Migrations/20260707000000_InitialCreate.cs`
